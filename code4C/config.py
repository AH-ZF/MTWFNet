...
parser = argparse.ArgumentParser(description='ME recognition ')
...
parser.add_argument('--is_split', default=False,
                    help='whether to use spliting data')



parser.add_argument('--save_path', default='result/mymodel', type=str,
...
# train phase*******************************************************************************************
parser.add_argument('--lambda_0', default=0.3, type=float,
                    help=' ')
...
parser.add_argument('--sde_cde3C', default='sde4C', type=str,
                    help='4C')
parser.add_argument('--isreport', default=False,
...
parser.add_argument('--isallparameters', default=False,
                    help='whether to use   to zf(False or True)')
...
parser.add_argument('--ram', default=False, type=bool,
                    help='  ')
parser.add_argument('--trainbatch_size', default=15, type=int,
                    help='  ')
...
parser.add_argument('--valtestbatch_size', default=4, type=int,
                    help='  ')
...
parser.add_argument('--breaksubxx', default='sub16', type=str,
                    help=' False or True ')
parser.add_argument('--savesubxx', default='sub15', type=str,
                    help=' False or True ')

beforsubs = ['sub01', 'sub02', 'sub03', 'sub04', 'sub05', 'sub06', 'sub07', 'sub08', 'sub09', 'sub10', 'sub11', 'sub12',
             'sub13', 'sub14', 'sub15']
